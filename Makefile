...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"snakemake","description":"Use snakemake via Binder"}'
	test -f README.md || echo "Snakemake Binder" >> README.md
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/snakemake.git
